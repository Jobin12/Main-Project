        ...
        <?php
            ...
            if(isset($_POST['add'])){
                ...
                if(!$name || !$id || !$email || !$college || !$contact || !$address || !$gender || !$password) echo "<script>alert('Insufficient Details')</script>";
                    ...
                    $sql="insert into student values('$email','$name','$id',$contact,'$college','$address','$gender','$password',1);";
            ...
            if(isset($_POST['edit'])){
                ...
                if(!$name || !$id || !$email || !$college || !$contact || !$address || !$gender || !$password) echo "<script>alert('Insufficient Details')</script>";
                    ...
                    $sql="update student set username='$name',id='$id',college='$college',mobile=$contact,gender='$gender',password='$password',address='$address' where email='$email' and access=1";
                    if(mysqli_query($conn,$sql)){
