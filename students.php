    ...
    <body>
        ...
        <?php
            ...
            if(isset($_POST['search'])){
                $name=$_POST['name'];
                if(!$name) echo("<script>alert('Enter Student Name')</script>");
                else{
                    $sql="select * from student where username='$name' and access=1";
                    ...
                    else echo("<script>alert('No Student found')</script>");
                }
            }
            else{
                $sql="select * from student where access=1";
                $result=mysqli_query($conn,$sql);
                if(mysqli_num_rows($result)>0){
                    echo "<table class='data' width = '800'>";
                    echo "<tr>";
